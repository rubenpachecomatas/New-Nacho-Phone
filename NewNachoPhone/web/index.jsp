            ...
            <div class="card-body">
                <form method="post" action="loginProceso.jsp">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-10">
                      <input id="mail" name="mail" type="text" placeholder="Here" class="form-control input-md" required="">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-10">
                        <input id="pwd" name="pwd" type="password" placeholder="Here" class="form-control input-md" required="">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-8">
                        <button id="enviar" name="enviar" class="btn btn-primary">Log In</button>
                        <a href="registro.jsp" class="btn btn-primary">Sign In</a>
                      </div>
                    </div>
